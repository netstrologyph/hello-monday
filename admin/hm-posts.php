...
<div id="exTab2" class="container">
    <ul class="nav nav-tabs">
        ...
        <li><a  href="<?php $url = admin_url(); ?>admin.php?page=Hello+Monday">Dashboard</a></li>
        <li><a href="<?php $url = admin_url(); ?>admin.php?page=hm_shortcodes">Shortcodes</a></li>
        <li class="active"><a href="<?php $url = admin_url(); ?>admin.php?page=hm_posts">HM Posts</a></li>        
        <li><a href="<?php $url = admin_url(); ?>admin.php?page=hm_settings">Settings</a></li>
        <li><a href="<?php $url = admin_url(); ?>admin.php?page=hm_support">Support</a></li>
    </ul>
    <div class="tab-content ">
        ...
        <div class="tab-pane active" id="1">
            <div class="row">
                <div class="col-md-12">
                    <h4>Hello Monday Posts</h4>
                    <a href="<?php echo home_url(); ?>/wp-admin/edit.php?post_type=hm_post">ALL POSTS</a><br clear="all" />
                    <a href="<?php echo home_url(); ?>/wp-admin/post-new.php?post_type=hm_post">ADD NEW POST</a><br clear="all" />
                    <a href="<?php echo home_url(); ?>/wp-admin/edit-tags.php?taxonomy=hm_category&post_type=hm_post">MANAGE CATEGORY</a>
                </div>
            </div>            
        </div>
   		</form>
